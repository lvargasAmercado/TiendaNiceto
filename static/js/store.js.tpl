...
DOMContentLoaded.addEventOrExecute(() => {
    ...
    {% set desktop_nav_fixed_width = settings.category_item or (settings.head_informative_banner_01_show or settings.head_informative_banner_02_show) %}
    ...
    {% if settings.head_informative_banner_01_show or settings.head_informative_banner_02_show %}
	...
	{% if template == 'home' %}
        ...
        {% set has_promotion_products_slider = sections.promotion.products and settings.promotion_products_format == 'slider' %}
        {% set has_best_seller_products_slider = sections.best_seller.products and settings.best_seller_products_format == 'slider' %}
        ...
        {% if (has_featured_products_slider or has_new_products_slider or has_sale_products_slider or has_promotion_products_slider or has_best_seller_products_slider) or theme_editor %}
            ...
            {% if has_featured_products_slider or theme_editor %}
                ...
                {% set featured_horizontal_item = settings.featured_products_horizontal_item %}
                var slidesPerViewFeaturedDesktopVal = {% if featured_horizontal_item %}3{% elseif featured_columns_desktop == 4 %}4{% elseif featured_columns_desktop == 5 %}5{% else %}6{% endif %};
                var slidesPerViewFeaturedMobileVal = {% if featured_columns_mobile == 1 or featured_horizontal_item %}1.15{% else %}2.25{% endif %};
            ...
            {% if has_new_products_slider or theme_editor %}
                ...
                {% set new_horizontal_item = settings.new_products_horizontal_item %}
                var slidesPerViewNewDesktopVal = {% if new_horizontal_item %}3{% elseif new_columns_desktop == 4 %}4{% elseif new_columns_desktop == 5 %}5{% else %}6{% endif %};
                var slidesPerViewNewMobileVal = {% if new_columns_mobile == 1 or new_horizontal_item %}1.15{% else %}2.25{% endif %};
            ...
            {% if has_sale_products_slider or theme_editor %}
                ...
                {% set sale_horizontal_item = settings.sale_products_horizontal_item %}
                var slidesPerViewSaleDesktopVal = {% if sale_horizontal_item %}3{% elseif sale_columns_desktop == 4 %}4{% elseif sale_columns_desktop == 5 %}5{% else %}6{% endif %};
                var slidesPerViewSaleMobileVal = {% if sale_columns_mobile == 1 or sale_horizontal_item %}1.15{% else %}2.25{% endif %};
            ...
            {% if has_promotion_products_slider or theme_editor %}
                ...
                {% set promotion_horizontal_item = settings.promotion_products_horizontal_item %}
                var slidesPerViewPromotionDesktopVal = {% if promotion_horizontal_item %}3{% elseif promotion_columns_desktop == 4 %}4{% elseif promotion_columns_desktop == 5 %}5{% else %}6{% endif %};
                var slidesPerViewPromotionMobileVal = {% if promotion_columns_mobile == 1 or promotion_horizontal_item %}1.15{% else %}2.25{% endif %};
            ...
            {% if has_best_seller_products_slider or theme_editor %}
                ...
                {% set best_seller_horizontal_item = settings.best_seller_products_horizontal_item %}
                var slidesPerViewBestSellerDesktopVal = {% if best_seller_horizontal_item %}3{% elseif best_seller_columns_desktop == 4 %}4{% elseif best_seller_columns_desktop == 5 %}5{% else %}6{% endif %};
                var slidesPerViewBestSellerMobileVal = {% if best_seller_columns_mobile == 1 or best_seller_horizontal_item %}1.15{% else %}2.25{% endif %};
        ...
        {% if (has_testimonial_01 or has_testimonial_02 or has_testimonial_03) or theme_editor %}
            createSwiper('.js-swiper-testimonials', {
                lazy: true,
                {% if has_testimonials or theme_editor %}
                    loop: true,
                {% endif %}
                centeredSlides: true,
                centerInsufficientSlides: true,
