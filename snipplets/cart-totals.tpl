...
{% if not cart_page %}
  ...
  <div class="js-visible-on-cart-filled h5 row mb-3 font-big font-weight-normal" {% if cart.items_count == 0 %}style="display:none;"{% endif %} data-store="cart-subtotal">
...
{% if cart_page %}
  ...
  <div id="cart-sticky-summary" class="position-sticky-md cart-page-totals">
    ...
    <div class="js-visible-on-cart-filled h5 row no-gutters font-big font-weight-normal mb-3" {% if cart.items_count == 0 %}style="display:none;"{% endif %} data-store="cart-subtotal">
