...
{% set section_class = 'section-products-related' %}
{% set alternative_section_class = complementary_products ? ' pb-4' %}
{% set container_class = 'container position-relative pr-0 pr-md-3' %}
{% set title_class = 'h3 section-title mb-3' %}
{% set slider_container_class = 'swiper-container p-1' %}
